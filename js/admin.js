      ...
      <fieldset>
          <div class="card1">
              ...
              <div class="action-btns">
                  <button class="btn-update" onclick="updateCourse('${e.course_number}')">
                      <i class="fa fa-pencil"></i> Update
                  </button>
                  <button class="btn-delete" onclick="deleteCourse('${e.course_number}')">
...
function deleteCourse(courseID){
  const index1 = courses.findIndex(course => course.course_number == courseID);
  if (index1 !== -1) {
    courses.splice(index1, 1);
    localStorage.courses = JSON.stringify(courses);
    displayCourses(courses); // Refresh the UI
  }
}
